// Netlify Function: /netlify/functions/outreach2
// Generiert personalisierte Instagram-DMs für Gesundheits-Coaching
//
// ENV-Variablen:
...
const SYSTEM_PROMPT = `Du bist ein Experte für Instagram-Marketing im Gesundheitsbereich und spezialisiert auf Gesundheits-Coaching.

AUFGABE: Schreibe personalisierte Instagram-DM-Nachrichten für ein Gesundheits-Coaching-Angebot.
...
exports.handler = async (event) => {
  ...
  const allergie = typeof payload.allergie === 'string' ? payload.allergie.trim() : 'Abnehmen allgemein';
